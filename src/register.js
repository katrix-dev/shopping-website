...
const Register = () =>{
  ...
  const save = () =>{
      ...
      axios.post(url, data).then(response=>{
        updateMessage(name + " Registered successfully!");
        pickName("");
        pickEmail("");
        pickMobile("");
        pickPassword("");
        ...
        <div className="container mt-5">
            <div className="row">
                ...
                <div class="bg-light rounded p-3">
					...
					<p class="alert alert-info text-center"> Enter Your Details {msg} </p>
						...
						<div class="text-center">
							<button class="btn btn-primary" onClick={save}>Register <i class="fa fa-arrow-right"></i> </button>
							<hr/>
						</div>
					</div>
